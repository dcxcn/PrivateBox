...
namespace PrivateBox.UserControls
{
    ...
    {        	
		...
		public bool CreateDoubleBuffer(Graphics g, int width, int height, int previewWidth, int previewHeight)
        {
            try
            {
                PrivateBox.UserControls.KP_DrawObject.UpdatePanelsize(width, height);
                PrivateBox.UserControls.KP_DrawObject.UpdatePreviewPanelsize(previewWidth, previewHeight);
